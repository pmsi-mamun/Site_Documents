...
def get_data_for_category_sweeps():
    ...
    sweeps = [14355,14356,14357,14358,14359,14360,14361,14362,14363,14364,14365,14366,14367,14368,14369,14370,14371,14372,14373,14374,14375,14376,14377,14378,14379]
    #,14380,14381,14382,14383,14384,14385,14386,14387,14388,14389,14390,14391,14392,14393,14394,14395,14396,14397,14398,14399,14400,14401,14402,14403,14404
    ...
    for sweep in sweeps:
        ...
        #response = es.get_data_for_qry_raw('scraping_herd_version_test', 'aldi_nord_stores', json.loads(query))
